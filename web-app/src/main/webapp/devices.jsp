    ...
    <%--<div class="main-panel">--%>
        ...
        <%--<div class="content" style="margin-top:5px ; padding: 0 0">--%>
            <%--&lt;%&ndash;<div class="container-fluid">&ndash;%&gt;--%>
                    ...
                    <%--&lt;%&ndash;<p  data-toggle="modal" data-target="#filter" style="  cursor:pointer;font-size: 20px; margin-left: 20px">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;FILTER <i class="material-icons">filter_list</i><div class="row" >&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</p>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--<div class="row">--%>
                    <%--<div class="col-md-12">--%>
